...
import SignOutNav from '../Navigation/SignOutNav';
import {getDate} from '../DumbComponents/SimpleFunctions';
import {getUserData} from '../Axios/UserRequests';
import {notificationRequests} from '../Axios/OtherRequests';
import MenuManageBets from '../Navigation/MenuManageBets';
import MenuManageGroups from '../Navigation/MenuManageGroups';
import MainProfile from './Profile/MainProfile';
import Notifications from './Other/Notifications';
import {calculateBalance, windowWidth} from '../DumbComponents/SimpleFunctions';
    ...
    render() {
        return (
            <div className="main-container main-background basic-column-fx wrap-fx" onClick={this.hideAccountModal}>
                {this.state.pageLoaded && !this.state.user ? <NonAuthHome navNonAuth={this.state.navNonAuth} handleNavigationClick={this.handleNavigationClick} /> :  
               ...
               />
                ...
                {this.state.pageLoaded && this.state.user ?  windowWidth(480) ? <SignOutNav navAuth={this.state.navAuth}  handleNavigationClick={this.handleNavigationClick} /> : null 
: null}
              ...
              <div id="middle-home-container" className="basic-fx justify-around-fx">
                  ...
                  <MenuManageBets menuClick={this.menuClick} notifications={this.state.waitingNotifications} />
                  <MenuManageGroups menuClick={this.menuClick} />
              </div>
              </Fragment>   : null
                  }
