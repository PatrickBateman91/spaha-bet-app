...
import { manageGroupsRequest} from '../../Axios/GroupRequests';
import { returnToMain, joinArrays} from '../../DumbComponents/SimpleFunctions';
...
class ManageGroups extends Component {
    ...
    handleChangeGroupName = (e) => {
        ...
        manageGroupsPromise.then(res => {
            ...
            this.setState({
                error:true,
                errorMessage:`Could not change the group's name!`
            })
        })
    }
